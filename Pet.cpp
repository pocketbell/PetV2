...
void Pet::SetState(Value value, int state)
{
	switch (value)
	{
	case Pet::Value::Mood:    m_moodState		=	(Pet::Mood)state;		break;
	case Pet::Value::Hunger:  m_hungerState		=	(Pet::Hunger)state;		break;
	case Pet::Value::Hygiene: m_hygieneState	=	(Pet::Hygiene)state;	break;
	}
}
...
{
	if      (m_mood > 80)		SetState(Pet::Value::Mood,		(int)Pet::Mood::Happy);
	else if (m_mood > 60)		SetState(Pet::Value::Mood,		(int)Pet::Mood::Okay);
	else if (m_mood > 40)		SetState(Pet::Value::Mood,		(int)Pet::Mood::Aggravated);
	else if (m_mood > 0)		SetState(Pet::Value::Mood,		(int)Pet::Mood::Sad);

	if      (m_hunger > 80)		SetState(Pet::Value::Hunger,	(int)Pet::Hunger::Full);
	else if (m_hunger > 60)		SetState(Pet::Value::Hunger,	(int)Pet::Hunger::Fine);
	else if (m_hunger > 40)		SetState(Pet::Value::Hunger,	(int)Pet::Hunger::Hungry);
	else if (m_hunger > 0)		SetState(Pet::Value::Hunger,	(int)Pet::Hunger::Starving);

	if      (m_hygiene > 80)	SetState(Pet::Value::Hygiene,	(int)Pet::Hygiene::Clean);
	else if (m_hygiene > 60)	SetState(Pet::Value::Hygiene,	(int)Pet::Hygiene::Normal);
	else if (m_hygiene > 40)	SetState(Pet::Value::Hygiene,	(int)Pet::Hygiene::Dirty);
	else if (m_hygiene > 0)		SetState(Pet::Value::Hygiene,	(int)Pet::Hygiene::Filthy);
}																		
